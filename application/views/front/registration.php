    ...
    <div class="contents">
        <div class="grid_wrapper">
            ...
            <div class="g_6 contents_header">
                <h3 class="i_16_forms tab_label">Регистрация</h3>
                <div><span class="label">Внесите ваши данные</span></div>
            </div>
            <div class="g_12 separator"><span></span></div>
            <div class="g_12">
                <div class="widget_header">
                    <h4 class="widget_header_title wwIcon i_16_checkbox">Все поля обезательные</h4>
                </div>
                <form action="/main/registration" method="POST">
                    <div class="widget_contents noPadding">

                        <div class="line_grid">
                            <div class="g_3"><span class="label">Логин</span>
                            </div>
                            <div class="g_9">
                                <input type="text" class="simple_field" name="name" />
                            </div>
                        </div>
                        <div class="line_grid">
                            <div class="g_3"><span class="label">Пароль</span>
                            </div>
                            <div class="g_9">
                                <input type="text" class="simple_field" name="password" />
                            </div>
                        </div>
                        <div class="line_grid">
                            <div class="g_3"><span class="label">Ваш ник</span>
                            </div>
                            <div class="g_9">
                                <input type="text" class="simple_field" name="nickname" />
                            </div>
                        </div>
                        <div class="line_grid">
